...
import { ListMusic, ChevronDown, ChevronUp, ExternalLink, Film, Trash2 } from 'lucide-react';
import { useLayoutEditor } from '../../context/LayoutEditorContext';

export default function LayerBlockList() {
  const { zones, selectedZoneId, availablePlaylists, mediaList, updateSelectedZone, setPickerZoneId, setMediaPickerZoneId } = useLayoutEditor();
