...
import { CreateTransitionRequest } from '@/lib/api/studio/v1/transition/transition.common_pb';
...
export async function POST(req: NextRequest) {
  try {
    ...
    const request = new CreateTransitionRequest();
    ...
    return new Promise<NextResponse>((resolve) => {
      client.createTransition(request, getGrpcMetadata(token), (error: any, response: any) => {
