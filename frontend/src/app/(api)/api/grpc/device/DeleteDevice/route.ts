...
import { DeleteDeviceRequest } from '@/lib/api/generated/hardware/v1/device/device.common_pb';
...
export async function POST(req: NextRequest) {
  try {
    ...
    return new Promise((resolve) => {
      client.deleteDevice(request, getGrpcMetadata(token), (error: any, response: any) => {
